...
public class PageDao {
	...
	public PageBean getResult(int page) throws Exception {  
        try {  
            ...
            String strSql = "select * from goods limit "+(pageNum-1) * pageBean.getPageSize()+","+pageBean.getPageSize();
            ...
            while (rs.next()) {    
                    ...
                    kb.setTrans(rs.getString("transmission"));
