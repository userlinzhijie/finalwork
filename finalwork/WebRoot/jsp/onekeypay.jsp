			...
			<form action="UserCtrl" method="post">
				...
				<div class="">
					<ul class="ul_cart">
						...
						<li class="ul_cart_do"><p>
								<a
									href="UserCtrl?action=add_collect&user_id=<%=value%>&goods_id='+obj[i].goods_id+'">收藏</a>
							</p>
							<p>
								<a href="UserCtrl?action=del_cart&id='+obj[i].id+'">删除</a>
							</p>
							<p>
								<a id="yjxd" href="">一键下单</a>
							</p></li>
					</ul>
				</div>
				<div class="next">
